    ...
    public void onUpdateReceived(Update update) {
        ...
        try {
            ...
            if (CURRENT_RATES.equalsIgnoreCase(message.getText())) {
                ...
                response.setText("Otpravte summu dohoda");
            } else if (ADD_SPEND.equalsIgnoreCase(message.getText())) {
                response.setText("Otpravte summu rashodov");
            } else {
            ...
            log.error("Voznikla problema soobshite adminu", e);
        }
    }
    ...
    public void sendNotificationToAllActiveChats(String message, Set<Long> chatIds) {
        for (Long id : chatIds) {
            ...
            try {
                ...
                log.error("Ne udalos' otpravit' soobshenie", e);
            }
        }
    }
